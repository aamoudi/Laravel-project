            ...
            <div class="row s_product_inner">
                <div class="col-lg-6">
                    <div class="s_Product_carousel">
                        <div class="single-prd-item">
                            <img class="img-fluid" src="{{asset('img/product/'. $product->cover_image .'')}}" alt="">
                        </div>
                        <div class="single-prd-item">
                            <img class="img-fluid" src="{{asset('img/product/'. $product->cover_image .'')}}" alt="">
                        </div>
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="s_product_text">
                        ...
                        <ul class="list">
                            <li class="active"><span>Category : </span>{{$category->name}}</li>
                        </ul>
                    ...
                    <div class="row">
                            ...
                            <div class="comment_list">
                                @foreach($product->comments as $comment)
                                    <div class="review_item">
                                        <div class="media">
                                            <div class="d-flex">
                                                <img style="width:70px;height:100px;" src="{{asset('img/default_user.png')}}" alt="">
                                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="review_box">
                                ...
                                <form class="row contact_form" action="{{route('addComment',$product->id)}}" method="get" id="contactForm"
